...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_barring_barrings_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_barring_collection_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_locales_fr_fr_mobile_data_fr_txt extends null { }
...
@:keep @:image("assets/images/barring/barrings.png") @:noCompletion #if display private #end class __ASSET__assets_images_barring_barrings_png extends lime.graphics.Image {}
@:keep @:image("assets/images/barring/collection.png") @:noCompletion #if display private #end class __ASSET__assets_images_barring_collection_png extends lime.graphics.Image {}
...
@:keep @:file("assets/locales/fr-FR/mobile_data_fr.txt") @:noCompletion #if display private #end class __ASSET__assets_locales_fr_fr_mobile_data_fr_txt extends haxe.io.Bytes {}
