...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("mobile_trouble", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("mobile_trouble", null, 1400, 880);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "9";
		app.meta["company"] = "";
		app.meta["file"] = "mobile_trouble";
		app.meta["name"] = "mobile_trouble";
